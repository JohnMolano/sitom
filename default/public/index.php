...
$carpetaProyecto = 'sitom';
define('APP_PAGE_OMOLDS', $http."://".$_SERVER['SERVER_NAME']."/".$carpetaProyecto."/");
 ...
 * Obtiene la url
 */
$url = ! empty ( $_SERVER [ 'REQUEST_URI' ])  ? $_SERVER [ 'REQUEST_URI' ]  :  (! empty ( $_SERVER [ 'ORIG_PATH_INFO' ])  ? $_SERVER [ 'ORIG_PATH_INFO' ]  :  '' );
$url = str_replace("/".$carpetaProyecto, "", $url);
