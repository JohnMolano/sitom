...
class Util
{
    ...
    public static function limpiarMiga($nombreVariable){
        $limpieza = array(  " " => "_",
                            "%20" => "_",
                            "á" => "a",
                            "é" => "e",
     ...
     /** FUNCION DE OMOLDS
     * Recibe una nombre de tabla como: item1,item2,item3 y retorna el resultado de la consulta de dicha tabla".
     */
    public static function joinOm($tableOm = 0){
        $omolds = new Omolds();
        $listData = $omolds->getOmoldTable($tableOm);
        #printVar( $listData); exit();
        return $listData;
    }
